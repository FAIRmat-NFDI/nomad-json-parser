...
```sh
git clone https://github.com/FAIRmat-NFDI/nomad-json-parser.git
cd nomad-json-parser
...
| Name | E-mail     |
|------|------------|
| FAIRmat | [fairmat@physik.hu-berlin.de](mailto:fairmat@physik.hu-berlin.de)
