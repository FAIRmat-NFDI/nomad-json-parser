...
def transform_subclass(  # noqa: PLR0913, PLR0917
    subclass_mapping,
    logger,
    jsonfile,
    archive,
...
def ruleblock_resolve(ruleblock, jsonfile, logger):  # noqa: PLR0912
    newruleblock = []
...
def map_with_nesting(  # noqa: PLR0912, PLR0913, PLR0917
